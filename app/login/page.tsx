    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen w-full">
            <div className="flex flex-col p-16 gap-4 bg-gray-600 rounded-lg shadow-md">
                <h1 className="flex flex-col text-4xl font-bold text-white items-center">Login</h1>
                <form className="flex flex-col gap-4" onSubmit={handleLogin}>
                    ...
                    <p>Don&apos;t have an account? <Link href="/register" className="text-blue-300">Register</Link></p>
                </form>
            </div>
        </div>
    )
